...
int main() {
	...
	int params = 14310; // 5 tasks with 1 agent 5673, 100 tasks with 0.25 p_active and 1 agent 15591
	...
	// not complete task_selection_methods.push_back("mcts_task_by_completion_reward_impact");
